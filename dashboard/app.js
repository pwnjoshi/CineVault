...
function getSampleCandidates() {
  return [
    {
      id: 'nara_1969_apollo_master',
      title: 'Apollo 11 Saturn V Launch (70mm NASA Archival Master)',
      source_name: 'National Archives (NARA)',
      source_url: 'https://archive.org/details/Apollo11Launch',
      thumbnail_url: 'https://images.unsplash.com/photo-1517976487492-5750f3195933?auto=format&fit=crop&w=800&q=80',
      ...
      pd_claim: 'verified',
      era: '1960s',
      resolution: '4K Ultra HD Telecine',
      color_profile: 'Kodachrome 70mm',
      notes: 'Verified statutory US Federal Government creation under 17 USC Section 105.'
    },
    {
      id: 'nara_1962_detroit_factory',
      title: 'Detroit Automotive Stamping Plant (1962 Heavy Machinery B&W)',
      source_name: 'Library of Congress (LOC)',
      source_url: 'https://archive.org/details/DetroitAssembly1962',
      ...
      notes: 'Public domain 35mm newsreel recording cleared for worldwide theatrical distribution.'
    },
    {
      id: 'ucla_hearst_metrotone',
      ...
      notes: 'Historical newsreel series preserved in UCLA Archive vault.'
    },
    {
      id: 'bfi_industrial_newsreel',
      title: 'BFI National Archive: 20th Century Industrial Collection',
      ...
      notes: 'BFI National Archive 35mm preservation scan.'
    },
    {
      id: 'efg_european_consortium',
      title: 'European Film Gateway: Multi-National Preservation Consortium',
      source_name: 'European Film Gateway (EFG)',
      source_url: 'https://www.europeanfilmgateway.eu',
      thumbnail_url: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=800&q=80',
      ...
      notes: 'Union catalog connecting 38 national film archives across Europe.'
    },
    {
      id: 'smithsonian_space_vault',
      title: 'Smithsonian Institution: Air & Space Exploration Vault',
      source_name: 'Smithsonian Institution Archives',
      source_url: 'https://si.edu',
      ...
      notes: 'Smithsonian National Air & Space Museum audiovisual preservation master.'
    }
  ];
}
